  ...
  if (userToken) {
    ...
    return (
      ...
      >
        ...
        <Stack.Screen name="Medical" component={MedicalScreen} options={{ animation: 'slide_from_right' }} />
        ...
        <Stack.Screen name="Age" component={AgeScreen} options={{ animation: 'slide_from_right' }} />
        <Stack.Screen name="SkinType" component={SkinTypeScreen} options={{ animation: 'slide_from_right' }} />
        <Stack.Screen name="FacialAreas" component={FacialAreasScreen} options={{ animation: 'slide_from_right' }} />

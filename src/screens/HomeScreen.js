        ...
        >
          <View style={styles.scoreLeft}>
            ...
            <Text style={styles.scoreHint}>
              {skinScore >= 80 ? 'Excellent! Keep it up' : skinScore >= 60 ? 'Good — room to improve' : 'Let\'s work on this together'}
            </Text>
          </View>
          <View style={styles.scoreRight}>
            <View style={styles.scoreCircle}>
              <MaterialCommunityIcons name="heart-pulse" size={28} color="#825A3B" />
            </View>
          </View>
        </Animated.View>
            ...
            >
              <View style={styles.profileTag}>
                ...
                <Text style={styles.profileTagText}>
                  {skinType.replace(/-/g, ' ').replace(/\b\w/g, (c) => c.toUpperCase())} Skin
                </Text>
              </View>
              {skinConcerns && skinConcerns.slice(0, 4).map((concern, i) => (
                <View key={i} style={styles.profileTag}>
                  <Text style={styles.profileTagText}>
                    {concern.replace(/-/g, ' ').replace(/\b\w/g, (c) => c.toUpperCase())}
                  </Text>
                </View>
              ))}
            </ScrollView>
